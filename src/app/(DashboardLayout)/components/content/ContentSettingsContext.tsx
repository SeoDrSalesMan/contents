...
const initialClients: Client[] = [
  ...
  { id: "distrito_legal", name: "Distrito Legal", webhook: "https://content-generator.nv0ey8.easypanel.host/webhook/distrito", ideasWebhook: "https://content-generator.nv0ey8.easypanel.host/webhook/ideas-distrito", structureWebhook: "https://content-generator.nv0ey8.easypanel.host/webhook/estructura-distrito", info: "Servicios legales online en España. Enfoque profesional con tono formal.", alcance: "", estilo: "", strategies: [
    ...
    { fecha: "2025-09-01", canal: "LinkedIn", formato: "Post profesional", titulo: "Nuevas regulaciones mercantiles 2025", descripcion: "Análisis de los cambios normativos que afectarán a las empresas españolas", keyword: "derecho mercantil, regulaciones", volumen: "Medio", tipos: "Educar, Inspirar", funnel: "MOFU" },
    ...
    { fecha: "2025-09-01", canal: "Blog", formato: "Guía práctica", titulo: "Contratos digitales: todo lo que necesitas saber", descripcion: "Manual completo sobre la validez y requisitos de los contratos en el ámbito digital", keyword: "contratos digitales, derecho digital", volumen: "Medio", tipos: "Educar, Entretener", funnel: "MOFU" },
    { fecha: "2025-09-01", canal: "Instagram", formato: "Carousel", titulo: "Derechos del consumidor en España", descripcion: "Infografía con los principales derechos que todo consumidor debe conocer", keyword: "derechos consumidor, protección", volumen: "Alto", tipos: "Educar, Promocionar", funnel: "TOFU" }
